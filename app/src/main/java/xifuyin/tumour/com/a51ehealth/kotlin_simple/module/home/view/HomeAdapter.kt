 ...
 */
class HomeAdapter(var context: Context, layoutResId: Int, data: List<HomeBean.Issue.Item>?) : BaseQuickAdapter<HomeBean.Issue.Item, BaseViewHolder>(layoutResId, data) {
