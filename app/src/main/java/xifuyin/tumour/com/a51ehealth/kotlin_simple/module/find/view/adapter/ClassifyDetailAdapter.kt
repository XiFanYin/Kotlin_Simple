 ...
 */
class ClassifyDetailAdapter(data: List<ClassifyDetailBean.Item>?, layout: Int) : BaseQuickAdapter<ClassifyDetailBean.Item, BaseViewHolder>(layout, data) {


    override fun convert(helper: BaseViewHolder, item: ClassifyDetailBean.Item) {
